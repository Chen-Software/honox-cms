...
Diese Komponente ist als `anchor`-Block im [Seitenbauer](/docs/PageBuilder) (`content/pages/*.json`) verfügbar:
...
`children` werden zu den Kindelementen des Ankers; jedes andere Feld wird direkt an `Anchor` durchgereicht.
